...
class Healthedia_Article_Controller extends Healthedia_Base_Controller {
	public function init( $loader ) {
		require_once HEALTHEDIA_PLUGIN_DIR . 'modules/Articles/class-article-cpt.php';
		...
		$cpt = new Healthedia_Article_CPT();
		$loader->add_action( 'init', $cpt, 'register' );

		$doi = new Healthedia_Article_DOI();
		$loader->add_action( 'save_post_healthedia_article', $doi, 'generate_doi_on_publish', 10, 3 );
