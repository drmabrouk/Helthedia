...
<div class="healthedia-gateway h-screen flex flex-col items-center justify-center bg-white text-[#111111] -mt-16">
	...
	<div class="w-full max-w-2xl relative">
		<form action="<?php echo home_url('/archive-search'); ?>" method="GET" class="w-full flex relative items-center">
			...
			<button type="submit" class="absolute right-2 top-2 bottom-2 bg-black text-white px-6 rounded-full font-sans uppercase text-sm tracking-wide hover:bg-gray-800 transition-colors flex items-center gap-2">
				<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
				Search
			</button>
		</form>
	</div>
	<div class="mt-6 flex flex-wrap justify-center gap-3 font-mono text-[10px] uppercase tracking-widest">
		<span class="search-tag px-4 py-1.5 border border-[#E0E0E0] rounded-full text-gray-500 hover:bg-gray-50 hover:text-black hover:border-black cursor-pointer transition-all">DOIs</span>
		<span class="search-tag px-4 py-1.5 border border-[#E0E0E0] rounded-full text-gray-500 hover:bg-gray-50 hover:text-black hover:border-black cursor-pointer transition-all">Researchers</span>
		<span class="search-tag px-4 py-1.5 border border-[#E0E0E0] rounded-full text-gray-500 hover:bg-gray-50 hover:text-black hover:border-black cursor-pointer transition-all">Clinical Trials</span>
	</div>
</div>
