...
<div class="max-w-4xl mx-auto py-12 px-4 bg-white text-[#111111]">
	...
	<div class="text-center border-b border-[#E0E0E0] pb-8 mb-10">
		<h1 class="text-4xl font-sans font-bold uppercase tracking-tight mb-2">Submit Standard Article</h1>
		<p class="font-mono text-xs text-gray-500 uppercase tracking-widest">General Educational & Informational Content</p>
	</div>
	...
	<div class="flex justify-between items-center mb-12 font-mono text-[10px] uppercase tracking-widest relative">
		...
		<div class="bg-black text-white px-4 py-1.5 rounded-full z-10 border-2 border-white">1. Write & Review</div>
		<div class="bg-gray-100 text-gray-400 px-4 py-1.5 rounded-full z-10 border-2 border-white">2. Moderation</div>
		<div class="bg-gray-100 text-gray-400 px-4 py-1.5 rounded-full z-10 border-2 border-white">3. Published</div>
	</div>
	...
	<form id="form-submit-article" class="space-y-8 bg-white border border-[#E0E0E0] rounded-2xl p-8 shadow-sm">
		...
		<div>
			<label class="block font-mono text-[10px] uppercase tracking-widest text-gray-500 mb-2">Article Content</label>
			<div class="border border-[#E0E0E0] rounded-xl overflow-hidden focus-within:border-black transition-colors">
				...
				<textarea id="ms-abstract" required rows="10" class="w-full px-4 py-3 font-sans outline-none resize-y" placeholder="Write your article here..."></textarea>
			</div>
		</div>

		<div class="border-t border-dashed border-[#E0E0E0] pt-8">
			<label class="block font-mono text-[10px] uppercase tracking-widest text-gray-500 mb-2">Cover Image (Optional)</label>
			<div class="border-2 border-dashed border-[#E0E0E0] rounded-xl p-8 text-center hover:border-black transition-colors bg-gray-50 relative">
				<div class="font-sans font-bold text-lg mb-1">Upload an image</div>
				<div class="font-mono text-[10px] uppercase tracking-widest text-gray-500" id="ms-file-name">Accepted formats: .JPG, .PNG</div>
				<input type="file" id="ms-file" accept="image/*" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
			</div>
		</div>
		...
		<div class="flex justify-end gap-4 pt-6">
			<button type="submit" id="btn-submit-ms" class="bg-black text-white px-8 py-3 rounded-full font-sans uppercase text-sm tracking-wide hover:bg-gray-800 transition-colors">Submit for Review</button>
		</div>
	</form>
</div>
