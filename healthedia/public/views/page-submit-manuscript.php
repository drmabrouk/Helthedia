...
<div class="max-w-4xl mx-auto py-12 px-4 bg-white text-[#111111]">
	...
	<div class="flex justify-between items-center mb-12 font-mono text-[10px] uppercase tracking-widest relative">
		...
		<div class="bg-black text-white px-4 py-1.5 rounded-full z-10 border-2 border-white">1. Metadata & Upload</div>
	...
	<form id="form-submit-manuscript" class="space-y-8 bg-white border border-[#E0E0E0] rounded-2xl p-8 shadow-sm">
		<div>
